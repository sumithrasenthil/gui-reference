...
class Window1(QDialog):
    ...
    def InitUI(self):
        ...
        self.label = QLabel(self)
        self.label.setPixmap(QPixmap('testing2.jpeg'))
        self.label.setGeometry(100, 100, 750, 800)
        #self.show()
        ...
        self.label = QtWidgets.QLabel(self)
        self.label.setText("<h1>ChargePay Welcomes you</h1>")
        self.label.setGeometry(QRect(350, 10, 525, 145))
        self.label.setStyleSheet('color:darkred')
        ...
        #self.label.setGeometry(QRect(900, 170, 625, 145))
        self.label1.setGeometry(QRect(950, 100, 525, 145))
        self.label1.setStyleSheet('color:darkred')
        self.setFont(QtGui.QFont("Bitter",13))
        ...
        button1.setGeometry(QRect(910, 250, 150, 45))
        
        

        #  Amount output
        button1 = QPushButton("  ", self)
        button1.setGeometry(QRect(1100, 250, 100, 45))
        ...
        button1.setFont(QtGui.QFont("Bitter",13))
        self.label1.setGeometry(QRect(955,345,190,45))
        self.label1.setStyleSheet('color:darkred')

        #Progress bar for charging
        self.progress = QProgressBar(self)
        self.progress.setGeometry(910, 410, 200, 25)
        self.progress.setMaximum(100)
        self.button = QPushButton('start', self)
        self.button.move(955, 490)
        ...
        self.label1.setGeometry(QRect(900, 650, 400, 45))
        self.label1.setStyleSheet('color:darkred')

        self.label1 = QtWidgets.QLabel(self)
        self.label1.setText("<h3>HAPPY JOURNEY</h2>")
        self.label1.setGeometry(QRect(930, 680, 300, 45))
        self.label1.setStyleSheet('color:darkred')
        self.label2 = QLabel(self)
        self.label2.setPixmap(QtGui.QPixmap('heart5.png'))
        self.label2.setGeometry(1090, 680, 40, 40)
